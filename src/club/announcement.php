...
<div class="row">
    <div class="col s12">
        <div class="card grey lighten-5">
            <form onsubmit="event.preventDefault(); announcement('Post', null, '<?php echo $club_id ?>', null, 'club')">
    ...
    <div class="col s12">
        <div class="card blue-grey darken-1">
            <form onsubmit="event.preventDefault();">
                ...
                <?php if ($club_role <= 2 && !isAdmin()) { ?>
                <div class="card-action">
                    <button class="link" type="submit" onclick="announcement('Update', '<?php echo $announcement['Announcement_ID'] ?>', '<?php echo $club_id ?>', null, 'club')">Update</a>
                    <button class="link" type="submit" onclick="announcementConfirm('Delete', '<?php echo $announcement['Announcement_ID'] ?>', '<?php echo $club_id ?>', null, 'club')">Delete</a>
                </div>
                <?php } ?>
            </form>
        </div>
